...
public class OmfRelocatableObjectExporter_Test {
	...
	@Test
	public void testEncodeZeroFillLidata16Bit() {
		byte[] encoded = OmfRelocatableObjectExporter.encodeZeroFillLidata(5, false);
	...
	@Test
	public void testEncodeZeroFillLidata32Bit() {
		byte[] encoded = OmfRelocatableObjectExporter.encodeZeroFillLidata(0x00010001L, true);
