 ...
 */
package ghidra.app.util.exporter.ascii_table.elf.linux_nolibc;
...
public class Mips_Test extends DelinkerIntegrationTest {
	private static final File main_file =
		new File("src/test/resources/programs/ascii-table/reference/elf/linux-nolibc/mips/main.o");

	private static final File openbsd_ctype_file =
		new File(
			"src/test/resources/programs/ascii-table/reference/elf/linux-nolibc/mips/openbsd_ctype.o");

	@Override
	protected String getProgramName() {
		return "src/test/resources/programs/ascii-table/reference/elf/linux-nolibc/mips/ascii-table.elf.gzf";
	}
	...
	public void test_main_o() throws Exception {
		...
		// .text bytes.
		assertSectionBytes(expected_text, 0x00008824, actual_text, 0x00000000, 0x00031c,
			new Patch(0x00000078, new byte[] { 0x0c, 0x00, 0x00, 0x00 }),
			new Patch(0x00000094, new byte[] { 0x0c, 0x00, 0x00, 0x00 }),
			new Patch(0x000000fc, new byte[] { 0x0c, 0x00, 0x00, 0x00 }),
			new Patch(0x00000108, new byte[] { 0x0c, 0x00, 0x00, 0x00 }),
			new Patch(0x00000118, new byte[] { 0x0c, 0x00, 0x00, 0x00 }),
			new Patch(0x00000130, new byte[] { 0x0c, 0x00, 0x00, 0x00 }),
			new Patch(0x00000144, new byte[] { 0x0c, 0x00, 0x00, 0x00 }),
			new Patch(0x00000150, new byte[] { 0x0c, 0x00, 0x00, 0x00 }),
			new Patch(0x000001a4, new byte[] { 0x0c, 0x00, 0x00, 0x00 }),
			new Patch(0x000001b8, new byte[] { 0x0c, 0x00, 0x00, 0x00 }),
			new Patch(0x0000021e, new byte[] { 0x00, 0x00 }),
			new Patch(0x00000222, new byte[] { 0x00, 0x00 }),
			new Patch(0x00000236, new byte[] { 0x00, 0x00 }),
			new Patch(0x0000023a, new byte[] { 0x00, 0x00 }),
			new Patch(0x0000025a, new byte[] { 0x00, 0x00 }),
			new Patch(0x0000025e, new byte[] { 0x00, 0x00 }),
			new Patch(0x0000028a, new byte[] { 0x00, 0x00 }),
			new Patch(0x0000028e, new byte[] { 0x00, 0x00 }),
			new Patch(0x00000294, new byte[] { 0x0c, 0x00, 0x00, 0x00 }),
			new Patch(0x0000029e, new byte[] { 0x00, 0x00 }),
			new Patch(0x000002a2, new byte[] { 0x00, 0x00 }),
			new Patch(0x000002b6, new byte[] { 0x00, 0x00 }),
			new Patch(0x000002ba, new byte[] { 0x00, 0x00 }),
			new Patch(0x000002dc, new byte[] { 0x0c, 0x00, 0x00, 0x00 }));
