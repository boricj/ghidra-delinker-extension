...
public class ExpectRelocationRelativeSymbol extends AbstractExpectRelocationBitmaskShifted {
	...
	public ExpectRelocationRelativeSymbol(long address, int width, long bitmask, int shift,
			String symbolName, long addend, String relativeSymbolName) {
		super(address, width, bitmask, shift, symbolName, addend);
