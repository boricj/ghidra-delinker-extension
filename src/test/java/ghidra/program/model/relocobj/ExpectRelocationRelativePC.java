...
public class ExpectRelocationRelativePC extends AbstractExpectRelocationBitmaskShifted {
	...
	public ExpectRelocationRelativePC(long address, int width, long bitmask, int shift,
