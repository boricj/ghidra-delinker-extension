...
public class Mipsel_Test extends DelinkerIntegrationTest {
	...
	private static final File main_file = new File(
		"src/test/resources/programs/freelist-allocator/reference/elf/linux-nolibc/mipsel/main.o");

	@Override
	protected String getProgramName() {
		return "src/test/resources/programs/freelist-allocator/reference/elf/linux-nolibc/mipsel/freelist-allocator.elf.gzf";
	}
	...
	public void test_main_o() throws Exception {
		...
		assertSymbol(actual_symtab, actual_rodata_index, 0x00000780, "s_heap_ranges", 0x28,
			STT_OBJECT, STV_DEFAULT, STB_GLOBAL);
		assertSymbol(actual_symtab, actual_rodata_index, 0x000007a8, "s_All_tests_passed._004127f0",
			0x14, STT_OBJECT, STV_DEFAULT, STB_LOCAL);
		...
		assertRels(actual_rel_text,
			new Rel(0x0000039c, R_MIPS_HI16, "s_All_tests_passed._004127f0"),
			new Rel(0x000003a0, R_MIPS_LO16, "s_All_tests_passed._004127f0"));
		...
		// .text bytes.
		assertSectionBytes(expected_text, 0x00008834, actual_text,
			0x00000000, (int) actual_text.getSize(),
			new Patch(0x000000e4, new byte[] { 0x00, 0x00, 0x00, 0x0c }),
			new Patch(0x00000150, new byte[] { 0x00, 0x00, 0x00, 0x0c }),
			new Patch(0x000001b4, new byte[] { 0x00, 0x00, 0x00, 0x0c }),
			new Patch(0x00000250, new byte[] { 0x00, 0x00, 0x00, 0x0c }),
			new Patch(0x000002ec, new byte[] { 0x00, 0x00, 0x00, 0x0c }),
			new Patch(0x00000384, new byte[] { 0x00, 0x00, 0x00, 0x0c }),
			new Patch(0x000003a4, new byte[] { 0x00, 0x00, 0x00, 0x0c }));
