...
public class ExpectRelocationRelativePC extends AbstractExpectRelocationBitmask {
	public ExpectRelocationRelativePC(long address, int width, long target, long addend) {
		super(address, width, target, addend);
	}

	public ExpectRelocationRelativePC(long address, int width, long bitmask, long target,
			long addend) {
