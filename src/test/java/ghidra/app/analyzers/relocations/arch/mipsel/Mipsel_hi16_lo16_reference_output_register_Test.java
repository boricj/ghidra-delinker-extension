...
public class Mipsel_hi16_lo16_reference_output_register_Test extends DelinkerIntegrationTest {
	...
	private static final List<Relocation> EXPECTED_RELOCATIONS = List.of(
		...
		new ExpectRelocationHighPair(0x00010008, 4, 0xffff, TARGET_SYMBOLS.get("PTR")),
		// 0000000c  00000206 R_MIPS_LO16       00000000   .data
		new ExpectRelocationLowPair(0x0001000c, 4, 0xffff, TARGET_SYMBOLS.get("PTR"), 0));

	@Override
	protected String getProgramName() {
		return "src/test/resources/arch/mipsel/reference/hi16_lo16_reference_output_register.gzf";
	}
